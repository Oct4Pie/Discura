...
export const API_ROUTES = {
  ...
  BOTS: {
    ...
    KNOWLEDGE_ITEM: (botId: string, itemId: string) => `/api/${BASE_ROUTES.BOTS}/${botId}/knowledge/${itemId}`,
  ...
  LLM: {
    ...
    PROVIDER_BY_ID: (provider: string) => `/api/${BASE_ROUTES.LLM}/providers/${provider}`
  },
