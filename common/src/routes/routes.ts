...
const models: TsoaRoute.Models = {
    ...
    "BotConfiguration": {
        ...
        "properties": {
            ...
            "llmProvider": {"dataType":"union","subSchemas":[{"dataType":"enum","enums":["openai"]},{"dataType":"enum","enums":["anthropic"]},{"dataType":"enum","enums":["google"]},{"dataType":"enum","enums":["custom"]}],"required":true},
