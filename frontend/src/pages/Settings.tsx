    ...
    <Box sx={{ width: "100%", maxWidth: "100%", overflow: "hidden" }}>
      ...
      <Box sx={{ display: "flex", flexWrap: "wrap", gap: 3 }}>
        ...
        <GridItem item xs={12} md={6}>
          <Card
            elevation={0}
            sx={{ border: `1px solid ${alpha(theme.palette.divider, 0.1)}` }}
          >
            <CardContent sx={{ p: 3 }}>
              <Box
              ...
              <List sx={{ mb: 3 }}>
                ...
                <ListItem sx={{ px: 0 }}>
                  ...
                  <ListItemText
                    ...
                    secondary={
                      typedUser?.id
                        ? new Date(parseInt(typedUser.id)).toLocaleDateString()
                        : "Not available"
                    }
                    primaryTypographyProps={{ fontWeight: 500 }}
                  />
            ...
            <CardContent sx={{ p: 3 }}>
              ...
              >
                <Typography variant="body2">
                  Coming soon: Customize the app appearance, notification
                  settings, and more.
                </Typography>
              </Paper>
          ...
          >
            <CardContent sx={{ p: 3 }}>
              ...
              <Typography variant="body2" paragraph>
                ...
                These will be used as defaults when creating new bots, but can
                be overridden for each bot.
              </Typography>
              ...
              >
                <Typography variant="body2" color="text.secondary">
                  Coming soon: Manage your OpenAI, Anthropic, and other API keys
                  from this page.
                </Typography>
              </Paper>
            </CardContent>
      ...
      >
        ...
        <DialogContent>
          <Typography variant="body2" color="text.secondary">
            ...
            in again to access your bots and settings.
          </Typography>
        </DialogContent>
