...
const BotList = () => {
  ...
  return (
    ...
    >
      ...
      {error && (
        <ValidationErrorDisplay error={error} onClose={() => clearError()} />
      )}
        ...
        {isLoading ? (
          ...
          <GridItem xs={12} item>
            ...
            >
              ...
              >
                Create your first Discord bot to get started. You can customize
                its personality, add integrations with AI models, and enhance
          ...
          bots.map((bot: FrontendBot) => (
            <GridItem xs={12} sm={6} md={4} key={bot.id} item>
              ...
              >
                ...
                >
                  {/* Replace separate start/stop buttons with a single toggle button */}
                  <Tooltip
                    title={
        ...
        {currentBotId && (
          <MenuItem
            onClick={() => {
              ...
              if (bot) {
                handleToggleBot(currentBotId, bot.status === BotStatus.ONLINE);
              }
            }}
            sx={{ py: 1.5 }}
          >
            {currentBotId &&
            bots.find((b) => b.id === currentBotId)?.status === BotStatus.ONLINE
              ? "Stop Bot"
              : "Start Bot"}
          </MenuItem>
        )}
