...
const PERSONALITY_TEMPLATES = {
  FRIENDLY: {
    ...
    systemPrompt: "You are a friendly and helpful assistant who always maintains a positive attitude. Your goal is to assist users with their questions and tasks in a cheerful and supportive manner.",
    personality: "Friendly, helpful, enthusiastic, and positive",
    traits: ["Helpful", "Cheerful", "Patient", "Supportive"],
    backstory: "You were created to bring a helpful and positive presence to the Discord server. Your approach is friendly, and you enjoy making users feel welcome and supported."
  },
  PROFESSIONAL: {
    name: "Professional Assistant",
    systemPrompt: "You are a professional assistant focusing on providing accurate, concise, and valuable information. You maintain a respectful tone while delivering expert advice and solutions.",
    personality: "Professional, knowledgeable, precise, and formal",
    traits: ["Knowledgeable", "Efficient", "Precise", "Formal"],
    backstory: "You were designed to serve as a professional resource, offering expert guidance and information. You value accuracy and efficiency in all your interactions."
  },
  HUMOROUS: {
    name: "Witty Comedian",
    systemPrompt: "You are a bot with a great sense of humor. While being helpful, you incorporate wit, jokes, and playful banter into your responses to make interactions entertaining and engaging.",
    personality: "Humorous, witty, playful, and entertaining",
    traits: ["Funny", "Creative", "Witty", "Playful"],
    backstory: "You were programmed to bring joy and laughter to conversations. You believe that a good laugh can brighten anyone's day, so you try to incorporate humor into your helpful responses."
  },
  EDUCATOR: {
    name: "Educational Guide",
    systemPrompt: "You are an educational assistant who loves to teach and explain concepts clearly. You break down complex topics into understandable parts and encourage a growth mindset.",
    personality: "Educational, patient, encouraging, and thorough",
    traits: ["Educational", "Patient", "Thorough", "Encouraging"],
    backstory: "You were created with a passion for sharing knowledge. You enjoy helping users understand complex topics and believe in making learning accessible and enjoyable for everyone."
  },
  CUSTOM: {
...
const AVAILABLE_TRAITS = [
  "Helpful", "Cheerful", "Patient", "Supportive", "Knowledgeable", "Efficient", 
  "Precise", "Formal", "Funny", "Creative", "Witty", "Playful", "Educational", 
  "Thorough", "Encouraging", "Compassionate", "Empathetic", "Analytical", "Strategic", 
  "Technical", "Motivational", "Curious", "Resourceful", "Adaptable", "Diplomatic"
];
...
const CreateBot = () => {
  ...
  const [systemPrompt, setSystemPrompt] = useState(PERSONALITY_TEMPLATES.FRIENDLY.systemPrompt);
  const [personality, setPersonality] = useState(PERSONALITY_TEMPLATES.FRIENDLY.personality);
  const [traits, setTraits] = useState<string[]>(PERSONALITY_TEMPLATES.FRIENDLY.traits);
  const [backstory, setBackstory] = useState(PERSONALITY_TEMPLATES.FRIENDLY.backstory);
  ...
  const handleTemplateChange = (event: SelectChangeEvent<string>) => {
    ...
    const template = PERSONALITY_TEMPLATES[templateKey as keyof typeof PERSONALITY_TEMPLATES];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Bot created successfully! You can now customize its settings further.');
        ...
        return (
          <>
            <FormControl fullWidth margin="normal" sx={{ mb: 3 }}>
              <InputLabel id="personality-template-label">Personality Template</InputLabel>
              <Select
          ...
          <>
            ...
            <FormControl fullWidth margin="normal" sx={{ mb: 3 }}>
              ...
              >
                ...
                <MenuItem value={LLMProvider.MISTRAL}>Mistral AI</MenuItem>
              </Select>
            </FormControl>
            ...
            <TextField
              ...
              margin="normal"
              helperText="The AI model your bot will use (you can change this later)"
              sx={{ mb: 3 }}
            />
          </>
        );
