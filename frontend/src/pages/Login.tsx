import { Box, Button, Paper, Typography, CircularProgress, alpha, useTheme } from '@mui/material';
      ...
      >
        ...
        <Box
          sx={{
            ...
            width: 100,
            height: 100,
            background: `linear-gradient(135deg, transparent 70%, ${alpha(theme.palette.primary.main, 0.1)} 70%)`,
            zIndex: 0
          }}
        />
