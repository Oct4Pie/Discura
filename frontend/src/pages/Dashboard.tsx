import { AddCircle as AddCircleIcon, SmartToy as BotIcon, Announcement as AnnouncementIcon, PlayArrow as StartIcon, Stop as StopIcon, ErrorOutline as ErrorIcon } from '@mui/icons-material';
import {
    Box,
    Button,
    Card,
