...
let theme = createTheme({
  ...
  shape: {
    borderRadius: 6, // Reduced from 12 for a more subtle, professional look
  },
  components: {
    MuiCssBaseline: {
      styleOverrides: {
    ...
    MuiCard: {
      styleOverrides: {
        root: {
          ...
          borderRadius: 8, // Significantly reduced from 20
          transition: "transform 0.2s ease-in-out, box-shadow 0.2s ease-in-out",
          overflow: "hidden",
    ...
    MuiPaper: {
      styleOverrides: {
        ...
        elevation2: {
          boxShadow:
            "0 3px 6px rgba(0, 0, 0, 0.05), 0 3px 6px rgba(0, 0, 0, 0.08)",
        },
        elevation8: {
          boxShadow:
