...
const MainLayout = () => {
      ...
      <Box sx={{ px: collapsed ? 0 : 2, py: 2 }}>
        ...
        <List sx={{ p: 0 }}>
          <ListItem disablePadding>
            ...
            >
              <ListItemIcon
                sx={{ minWidth: collapsed ? 0 : 40, mr: collapsed ? 0 : 2 }}
              >
                <DashboardIcon />
              </ListItemIcon>
        ...
        <List sx={{ p: 0 }}>
          <ListItem disablePadding>
            <ListItemButton
              ...
              selected={
                isRouteActive("/bots") && !isRouteActive("/bots/create")
              }
              sx={{
                borderRadius: collapsed ? 0 : 2,
                py: 1.5,
  ...
  // Render avatar and username - use discordId instead of id for Discord CDN
  const userAvatar = typedUser?.avatar
    ? `https://cdn.discordapp.com/avatars/${typedUser.discordId}/${typedUser.avatar}.png`
          ...
          >
            ...
            >
              ...
              <MenuItem
                ...
                sx={{ py: 1.5, borderRadius: 1, mx: 1, width: "auto" }}
              >
