...
function sanitizeData(data: any): any {
  ...
  const sensitiveFields = ['password', 'token', 'apiKey', 'discordToken', 'authorization'];
...
export const requestLogger = (req: Request, res: Response, next: NextFunction): void => {
  ...
  function endFn(this: Response, chunk: any, encoding: BufferEncoding, cb?: (() => void)): Response;
  function endFn(this: Response, chunkOrCb?: any, encodingOrCb?: any, callback?: any): Response {
    ...
    return originalEnd.call(this, chunkOrCb, encodingOrCb as BufferEncoding, callback);
  }
